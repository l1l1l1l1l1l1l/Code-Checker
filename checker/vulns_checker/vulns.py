...
# @return score: floating ranged from 0 to 1, 1 is best, 0 is worst in terms of code quality
def Check(tarRepo, loc):
    tarRepo = '/home/diyuan/pythonRepo/pythondotorg'
    ret = subprocess.run(['python3', '-m', 'bandit', '-r', tarRepo, '-q', '-f', 'csv'], stdout=subprocess.PIPE).stdout.decode('utf-8')
